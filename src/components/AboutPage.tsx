...
export default function AboutPage({ lang, theme }: AboutPageProps) {
  const content = {
    ua: {
      ...
      desc1: 'KREDO — це передова фінтех-платформа, створена для забезпечення повної фінансової та юридичної безпеки розрахунків між контрагентами. Ми усуваємо ризики шахрайства, невиконання зобов’язань та фінансових втрат при купівлі-продажу послуг, цифрових та матеріальних активів.',
      desc2: 'Завдяки прозорій ескроу-моделі кошти покупця надійно утримуються на безпечному транзитному рахунку та виплачуються продавцю тільки после успішної перевірки результатів угоди.',
      ...
      val2Desc: 'Захищений транзитний ескроу-процес гарантує збереження фінансів.',
    ...
    en: {
      ...
      subtitle: 'Modern high-tech escrow infrastructure for absolute business protection.',
      desc1: 'KREDO is an advanced fintech platform designed to ensure perfect financial and legal safety of payments between counterparties. We eliminate the risks of fraud, default, and financial losses when purchasing services, digital products, and physical assets.',
      desc2: 'With our transparent escrow model, the buyer’s funds are safely held in a transit custody account and only released to the seller after the successful verification of the deliverables.',
      ...
      val2Desc: 'A locked, segregated escrow engine guarantees secure custody of funds.',
    ...
    ru: {
      ...
      desc1: 'KREDO — передовая финтех-платформа, созданная для обеспечения полной финансовой и юридической безопасности расчетов между контрагентами. Мы полностью исключаем риски мошенничества, невыполнения обязательств и денежных потерь при покупке услуг, цифровых и физических активов.',
      desc2: 'Благодаря прозрачной эскроу-модели средства покупателя надежно удерживаются на безопасном транзитном счете и перечисляются продавцу только после успешной проверки результатов сделки.',
      ...
      val2Desc: 'Защищенный транзитный эскроу-процесс гарантирует абсолютную сохранность финансов.',
